...
@app.put("/working-lists/{list_id}/items/{item_id}")
...
@app.delete("/working-lists/{list_id}/items/{item_id}")
...
@app.delete("/working-lists/{list_id}/items")
...
@app.post("/working-lists/{list_id}/reorder")
async def reorder_working_list(list_id: str, request: WorkingListReorderRequest):
    ...
    # Map reordered texts back to item IDs
    ...
    # Append any unmatched IDs at the end
...
@app.post("/working-lists/{list_id}/dump-to-reminders")
...
@app.post("/usuals/add-to-working-list")
